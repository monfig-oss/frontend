...
![Pinia](https://img.shields.io/badge/pinia-FADA5E?style=for-the-badge&logo=vue.js&logoColor=white) 
...
### Code Quality
![Code Climate maintainability](https://qlty.sh/gh/monfig-oss/projects/frontend/maintainability.svg?style=for-the-badge)
![Code Climate coverage](https://qlty.sh/gh/monfig-oss/projects/frontend/coverage.svg?style=for-the-badge)
...
We use [SemVer](http://semver.org/) for versioning. For available versions, see the [tags in this repository](https://github.com/monfig-oss/frontend/tags).
